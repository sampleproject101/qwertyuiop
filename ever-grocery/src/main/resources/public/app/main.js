...
define(['durandal/system', 'durandal/app', 'durandal/viewLocator', 'modules/settingsservice', 'bootstrap', 'modules/kocustombindings'],  function (system, app, viewLocator, settingsService) {
